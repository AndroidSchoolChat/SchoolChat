...
public class MoldeGrupo implements Parcelable{
    ...
    public static final Creator<MoldeGrupo> CREATOR = new Creator<MoldeGrupo>() {
        @Override
        public MoldeGrupo createFromParcel(Parcel in) {
            return new MoldeGrupo(in);
        }

        @Override
        public MoldeGrupo[] newArray(int size) {
            return new MoldeGrupo[size];
        }
    };
}
